...
public class DataProvider {
    ...
    private static List<Buaya> intDataBuaya(Context ctx) {
        List<Buaya> buayas = new  ArrayList<>();
        buayas.add(new Buaya("Buaya muara", "indonesia dan australia",
                "Buaya yang besar.ukurannya bisa mencapai 7 meter - 8 meter dengan berat 200 kilogram. buaya ini biasa hidup di hulu sungai hingga kelaut.buaya muara adalah buaya terganas yang ada di indonesia dan australia",
                R.drawable.buaya_muara));
        buayas.add(new Buaya("Buaya siam","indonesia,malasyia,thailand dan kamboja",
                "Namanya buaya siam tapi orang jawa menyebutnya buaya kodok, buaya yang hidup di jawa dan kalimantan ini ukurannya cukup kecil,haya 2-3 meter. Buaya siam terbesar haya 4 meter.Buaya siam biasanya tinggal di perairan tenang,seperti rawa dan sungai.",
                R.drawable.buaya_siam));
        buayas.add(new Buaya("Buaya irian","Irian",
                " sesuai dengan namanya,buaya ini hidup di perairan tawar irian.secara fisik,buaya irian mirip dengan buaya muara. ukuran tubuh buaya irian bisa mencapai 3,3 meter, sedangkan ukuran buaya irian betina ukuran tubuhnya bisa mencapi 2,6 meter.",
                R.drawable.buaya_irian));
        buayas.add(new Buaya("Buaya sapit","sumatra",
                " Tubuh buaya sapit/ senyulong memang mirip dengan buaya .tetapi, hewan ini memiliki genus yang berbeda dengan buaya. Buaya sepit punya moncong yang runcing dan kecil. lalu tubuh bagaian atasnya tidak terlalu berseri, seperti buaya pada umumnya",
                R.drawable.buaya_sapit));
        return buayas;
    }
    ...
    private static void initAllHewans(Context ctx) {
        ...
        hewans.addAll(intDataBuaya(ctx));
    }
